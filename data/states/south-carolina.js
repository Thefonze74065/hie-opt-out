...
window.stateData['sc'] = {
	...
	hieOptOut: {
		available: true,
		law: "South Carolina Health Information Exchange Rules",
		lawUrl: "https://scdhec.gov/",
		...
		template: "I request to exercise my right to opt out of participation in South Carolina Health Information Exchange networks. I understand that this will prevent my health data from being shared across participating networks, and I request that your office provide the necessary form and instructions to complete this request.",
		majorProviders: [
			"musc-health",
			"prisma-health",
			"mcleod-health"
