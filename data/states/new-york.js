...
window.stateData['ny'] = {
	...
	hieOptOut: {
		available: true,
		law: "New York Health Information Exchange Rules",
		lawUrl: "https://health.ny.gov/",
		...
		template: "I request to exercise my right to opt out of participation in New York Health Information Exchange networks. I understand that this will prevent my health data from being shared across participating networks, and I request that your office provide the necessary form and instructions to complete this request.",
		majorProviders: [
