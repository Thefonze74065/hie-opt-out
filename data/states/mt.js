...
window.stateData['mt'] = {
    ...
    "rawPolicies": {
        "state sponsored HIE organization consent policies": {
            "organization_launch_date": "HealthShare Montana",
            "type_of_consent_policy": "No Information Available",
            "details_of_consent_policy": null,
            "patient_notification_methods": null,
            "additional_information": "Montana&apos;s Designated Health Information Exchange Organization",
        ...
        "apply minimum necessary standard to treatment disclosures of mental health info": {
            ...
            "requires_authorization_for_one_or_more_tpo_disclosures_that_would_be_permitted_under_hipaa_without_authorization": null,
            "citation_of_statute_or_regulation": "Mont. Code. Ann. &sect; 53-21-166",
            "citation_of_statute_or_regulation_url": "http://leg.mt.gov/bills/mca/53/21/53-21-166.htm",
            "narrative_description_of_state_law": "Montana authorizes health care providers to disclose a patient&apos;s health care information, without authorization, to any health care provider has previously provided services to the patient. Such disclosures must be limited to the extent the necessary to provide treatment and are prohibited if a patient requests that their provider not make such disclosures.",
            "definition_or_scope_of_information_material_covered_by_policy": "Records and information obtained and maintained while providing services to persons with serious mental illness in accordance with Montana&apos;s mental health law (Mont. Code. Ann. &sect; 53-21-166). Health care information. Defined as information related to a patient&apos;s health care that either identifies the patient or can identify the patient (Mont. Code Ann.&sect; 50-16-50 et seq.)."
        },
