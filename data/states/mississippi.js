...
window.stateData['ms'] = {
	...
	hieOptOut: {
		available: true,
		law: "Mississippi Health Information Exchange Rules",
		lawUrl: "https://msdh.ms.gov/",
		...
		template: "I request to exercise my right to opt out of participation in Mississippi Health Information Exchange networks. I understand that this will prevent my health data from being shared across participating networks, and I request that your office provide the necessary form and instructions to complete this request.",
		majorProviders: [
