...
window.stateData['wa'] = {
    ...
    "status": "inactive",
    "hie": {
        "name": "Washington State Health Information Exchange (OneHealthPo rt) (2012)",
        "type": "no-policy",
        "isActive": false,
        "contact": {
            "phone": null,
            "email": null,
            "website": "http://www.onehealthport.com/hie",
            "optOutFormUrl": null
        },
        "optOut": {
            "available": false,
            "process": "Secondary research required",
            "steps": [],
    ...
    "mentalHealth": {
        ...
        "statute": "West&apos;s RCWA 70.02.230",
        "statuteUrl": "http://app.leg.wa.gov/rcw/default.aspx?Cite=70.02.230"
    },
    "lastUpdated": "2025-01-01",
    "rawPolicies": {
        "state sponsored HIE organization consent policies": {
            "organization_launch_date": "Washington State Health Information Exchange (OneHealthPo rt) (2012)",
            "type_of_consent_policy": "No Information Available",
            "details_of_consent_policy": "Secondary research required",
            "patient_notification_methods": null,
            "additional_information": "OneHealthPort HIE is designated by the State of Washington as the statewide health information exchange. Consortium of founders include: The Everett Clinic, First Choice Health Network, Group Health Cooperative, Premera Blue Cross, Regence BlueShield, The Sisters of Providence and Swedish Hospital OneHealthPort is also responsible for attracting public and private sector stakeholders to invest and participate in the HIE. Oversight and governance is handled by a public- private sector organization. OneHealthPort is a secure portal that opens the door to valuable business and clinical solutions with a single way to sign on to local healthcare sites and online services for healthcare professionals. Created by a coalition of health plans, physicians, and hospitals that joined together to build a community where information could be shared securely and simply.",
            "websites_and_publicly_available_resources": [
                "http://www.onehealthport.com/hie",
                "http://www.onehealthport.com/participants"
            ],
        ...
        "require auth to disclose mental health info for TPO": {
            ...
            "citation_of_statute_or_regulation": "West&apos;s RCWA 70.02.230",
            "citation_of_statute_or_regulation_url": "http://app.leg.wa.gov/rcw/default.aspx?Cite=70.02.230",
            ...
            "definition_or_scope_of_information_material_covered_by_policy": "Information and records created or obtained while providing mental health services, including fact of admission (West&apos;s RCWA 70.02.030)."
        }
    }
};
