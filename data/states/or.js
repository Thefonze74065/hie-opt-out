...
window.stateData['or'] = {
    ...
    "status": "inactive",
    "hie": {
        "name": "Care Accord (Oregon&apos;s State Information Exchange)",
        "type": "no-policy",
        "isActive": false,
        "contact": {
            "phone": null,
            "email": null,
            "website": "https://www.careaccord.org/hie-in-oregon/overview.shtml",
            "optOutFormUrl": null
        },
        "optOut": {
            "available": false,
            "process": "Patient consent must be obtained before transmitting information in all situations as is required by state/federal law.",
            "steps": [],
    ...
    "rawPolicies": {
        "state sponsored HIE organization consent policies": {
            "organization_launch_date": "Care Accord (Oregon&apos;s State Information Exchange)",
            "type_of_consent_policy": "No Information Available",
            "details_of_consent_policy": "Patient consent must be obtained before transmitting information in all situations as is required by state/federal law.",
            "patient_notification_methods": null,
            "additional_information": "No further information can be found on the website regarding the consent model or policy for Care Accord Oregon",
            "websites_and_publicly_available_resources": [
                "https://www.careaccord.org/hie-in-oregon/overview.shtml"
            ],
        ...
        "state HIE consent policies": {
            ...
            "patient_notification_methods": null,
            "additional_information": "Oregon state government seems to be working on developing a consent policy, according to the materials  here.",
            "websites_and_publicly_available_resources": [
