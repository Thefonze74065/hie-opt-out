...
window.stateData['sd'] = {
	...
	hieOptOut: {
		available: true,
		law: "South Dakota Health Information Exchange Rules",
		lawUrl: "https://doh.sd.gov/",
		...
		template: "I request to exercise my right to opt out of participation in South Dakota Health Information Exchange networks. I understand that this will prevent my health data from being shared across participating networks, and I request that your office provide the necessary form and instructions to complete this request.",
		majorProviders: [
			"sanford-health",
			"avera-health"
		],
