...
window.stateData['pa'] = {
	...
	hieOptOut: {
		available: true,
		law: "Pennsylvania Health Information Exchange Rules",
		lawUrl: "https://www.health.pa.gov/",
		...
		template: "I request to exercise my right to opt out of participation in Pennsylvania Health Information Exchange networks. I understand that this will prevent my health data from being shared across participating networks, and I request that your office provide the necessary form and instructions to complete this request.",
		majorProviders: [
			"upmc",
			"penn-medicine",
			"geisinger",
